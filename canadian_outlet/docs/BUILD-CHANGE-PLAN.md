...
| C3 ✅ LANDED | **Quarantine intake** — unclear fulfillment creates a real, flagged Sales Order barred from stock/shipping/invoicing; classify action releases it; INV-6 rewritten accordingly | D3 | Unclear → exception ticket, no order |
